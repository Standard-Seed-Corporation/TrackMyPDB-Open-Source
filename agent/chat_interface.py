"""
TrackMyPDB Chat Interface
Web-based UI for interacting with the intelligent agent
...
from trackmypdb_agent import TrackMyPDBAgent, AgentSession, create_protein_analysis_workflow

# Configure Streamlit
st.set_page_config(
    page_title="TrackMyPDB Agent Chat",
    page_icon="🧬",
    layout="wide",
...
with col2:
    ...
    st.markdown('<div class="subtitle">Intelligent Bioinformatics Research Assistant</div>', unsafe_allow_html=True)
...
<div style='text-align: center; color: #999; font-size: 0.9em;'>
    <p>TrackMyPDB Intelligent Agent • Powered by Claude API & MCP Tools</p>
